...
static AsmInstructionMatch possibleInstructions[] = {
	...
	{ 0x1, {0xFF}, {0x56} },							// push %esi
        // Additional instructions discussed on
        // http://sourceforge.net/mailarchive/message.php?msg_name=2125AC80-1251-43A9-9FED-B55140FBD099%40mac.com
        // John Turnipseed:
        { 0x6, {0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00}, {0x81, 0xEC, 0x00, 0x00, 0x00, 0x00} }, // sub $0x????????,%esp
        { 0x3, {0xFF, 0xFF, 0x00}, {0x8b, 0x45, 0x00} },                                // mov 0x??(%ebp),%eax
        { 0x3, {0xFF, 0xFF, 0x00}, {0x8b, 0x55, 0x00} },                                // mov 0xffffff??(%ebp),%edx
        // Rainer Schmid:
        { 0x6, {0xFF, 0xFF}, {0x31, 0xc0} },
        { 0x5, {0xFF, 0x00, 0x00, 0x00, 0x00}, {0xba, 0x00, 0x00, 0x00, 0x00} },
	{ 0x0 }
};
#elif defined(__x86_64__)
static AsmInstructionMatch possibleInstructions[] = {
